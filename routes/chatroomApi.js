...
router.post('/existingMessages', chatroomAPIController.existingMessages);// async (req, res) => {
...
router.post('/find-and-delete-msg', chatroomAPIController.findAndDeleteMsg );//(req, res) => {
...
router.post('/save-msg', chatroomAPIController.saveMsg );//(req, res) => {
//     try{
//         const messageId = req.body.msgId;
//         const newMsg = req.body.newInput;
//
